      ...
      <!-- END ALERTS AND CALLOUTS -->
        ...
        <div class="row">
          ...
          <div class="col-12">
            ...
            @if($fav_distributors->count()> 0)   
@foreach($fav_distributors as $value)
<a href="">
            <div class="card">
     <div class="card-header d-flex p-0">
               ...
               <form id="delete-frm" class="" action="{{ route('favourite.destroy', $value->id) }}" method="POST">
   	{{ csrf_field() }}
								{{ method_field('DELETE') }}
    
              <button type="submit" class="btn btn-primary" style="background:none; border:none;color:red">Remove From Pool</button>
              
              </form></a>
                      <a class="dropdown-item" tabindex="-1" href="/retailers/distributors/{{ $value->distributor_id }} "><button class="btn btn-primary"  style="background:none; border:none;color:black">View Products</button></a>
              ...
              <div class="card-body">
                    ...
                    Dealers In <b><span style="color: #51be78;"><u>{{ $value->category }}</u></span></b></p>
