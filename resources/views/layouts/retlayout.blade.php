      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open" >
            <a href="{{ route('retailers/dashboard') }}" class="nav-link active" style="background: #51be78;">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('favourite.index') }}" class="nav-link">
                  <i class="fas fa-bookmark nav-icon" style="color: #51be78;"></i>
                  <p>My Pool</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('distributors.index') }}" class="nav-link">
                  <i class="fas fa-list nav-icon" style="color: #51be78;"></i>
                  <p>All Wholesalers</p>
                </a>
              </li>
            </ul>
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{ route('corders.index') }}" class="nav-link" >
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
              <i class="nav-icon fas fa-user-cog" style="color: #51be78;"></i>
              <p>
                My Account
                <i class="fas fa-angle-right right" style="color: #51be78;"></i>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/retailers/profile/create" class="nav-link">
                  <i class="fas fa-plus nav-icon" style="color: #51be78;"></i>
                  <p>Add Profile</p>
                </a>
              </li>
        ...
        <li class="nav-item">
          <a href="{{ route('cart.index') }}" class="nav-link">
              <i class="nav-icon fas fa-cart-plus" style="color: #51be78;"></i>
              <p>
                Cart
                <span class="badge badge-info right" style="background: #51be78;">{{ \App\Models\retailers\Cart::where('retailer_id',auth()->user())->count()}}</span>
              </p>
            </a>
          </li>
             <li class="nav-item">
          <a href="{{ route('cart.index') }}" class="nav-link">
              <i class="nav-icon fas fa-map-marker-alt" style="color: #51be78;"></i>
              <p>
                Delivery Tracker
